...
abstract class _$$CloudsDtoImplCopyWith<$Res>
  ...
  factory _$$CloudsDtoImplCopyWith(
    _$CloudsDtoImpl value,
    $Res Function(_$CloudsDtoImpl) then,
...
class __$$CloudsDtoImplCopyWithImpl<$Res>
  ...
  __$$CloudsDtoImplCopyWithImpl(
    _$CloudsDtoImpl _value,
    $Res Function(_$CloudsDtoImpl) _then,
  ) : super(_value, _then);
...
class _$CloudsDtoImpl implements _CloudsDto {
  const _$CloudsDtoImpl({@JsonKey(name: 'all') required this.all});
  ...
  Map<String, dynamic> toJson() {
    return _$$CloudsDtoImplToJson(this);
  }
}

abstract class _CloudsDto implements CloudsDto {
  const factory _CloudsDto({@JsonKey(name: 'all') required final int all}) =
      _$CloudsDtoImpl;
