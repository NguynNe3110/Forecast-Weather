...
class _WeatherApi implements WeatherApi {
  ...
  Future<CurrentWeatherResponse> getCurrentWeather(String city) async {
    ...
    final _options = _setStreamType<CurrentWeatherResponse>(
  ...
  Future<ForecastWeatherResponse> getForecastWeather(String city) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ForecastWeatherResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'forecast',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ForecastWeatherResponse _value;
    try {
      _value = ForecastWeatherResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
